...
void spi_init(void)
{
	...
	*/
	...
	SPCON = 0x33;																			// 110011  spro,spr1 -Fclk/16 . mstr-Set to configure the SPI as a Master ,ssdis-Set to disable SS in both Master and Slave modes.																																		
	IEN1|= 0x04;																		 // 100 SPI interrupt Enable bit Cleared to disable SPI interrupt.Set to enable SPI interrupt.
	EA= 1;																					//enable interrupts EA=_; 
	SPCON|= 0x40;																		// 1000000  Set to enable the SPI interface.
}
